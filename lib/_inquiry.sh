...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu codigo que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  printf "\n\n"
  printf "   [0] Instalar PowerTech\n"
  printf "   [1] Atualizar PowerTech\n"
  printf "   [2] Deletar PowerTech\n"
  printf "   [3] Bloquear PowerTech\n"
  printf "   [4] Desbloquear PowerTech\n"
  printf "   [5] Alter. dominio PowerTech\n"
  printf "\n"
  read -p "> " option
